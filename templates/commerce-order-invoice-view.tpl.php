                        ...
                        <table class="details" width="100%" cellspacing="0" cellpadding="0" style="font-family: verdana, arial, helvetica; font-size: 1em;">
                          <tr>
                            <td valign="top" width="50%">
                              <br/>
                              <b><?php print t('Account') .':'; ?></b> <?php print $info['order_uid']; ?><br/>
                              <!--<b><?php echo '<pre>'; print_r($info); echo '</pre>'; ?></b><br/>-->
                              <br/>
                              <b><?php print t('Date') .':'; ?></b> <?php print date('j F, Y', $info['order_created']); ?><br/>
                              <br/>
                            ...
                            <td valign="top" width="50%">
                              <br/>
                              <b><?php print t('Order number') .':'; ?></b> <?php print $info['order_number']; ?><br/>
                              <br/>
                              <b><?php print t('Email') .':'; ?></b> <?php print $info['order_mail']; ?><br/>
                              <br/>
